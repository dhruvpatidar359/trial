...
function Listing({listing,handleSearchClick,searchedAddress,
  ...
  return (
    <div>
        <div className="p-3 flex flex-col gap-6 md:flex-row md:items-center">
            ...
            <div className="flex gap-2 md:ml-4">
                ...
                <Button className="flex gap-2" onClick={reload} variant="destructive">
        ...
        {address&&
            <div className='px-3 my-5'>
                <h2 className='text-xl'>
                    Found&nbsp;
                    <span className='font-bold'>{listing?.length}</span> 
                    &nbsp;Result in&nbsp; 
